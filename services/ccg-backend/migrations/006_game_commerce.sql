...
comment on table game_products is
  'Server-authoritative catalogue for CCG game purchases. C64 Dungeon Carnage retains the legacy product slug and is seeded as a one-time GBP 1.99 permanent unlock including all future game updates.';
...
comment on table game_entitlements is
  'Account-owned game licences. The C64 Dungeon Carnage entitlement is permanent and version-independent so future game updates remain included.';
