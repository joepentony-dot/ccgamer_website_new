...
console.log('CCG migration runner contract passed: explicit apply, no-op replay, seven-migration ledger and checksum drift refusal work on PostgreSQL 17.');
