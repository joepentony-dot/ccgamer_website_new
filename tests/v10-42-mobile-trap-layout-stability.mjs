...
assert.match(source,/if\(chainHas\(current,"__ccgV142R19MobileTrapDamage"\)\)return true/,"trap guard installation must settle when one R19 owner already exists anywhere in the hurtPlayer ancestry");
