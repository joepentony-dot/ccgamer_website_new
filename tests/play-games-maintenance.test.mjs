...
assert.match(dungeon, /c64-dungeon-carnage-home-v2\.webp\?v=20260922-owner-preview/, "Dungeon loader must cache-bust the supplied WebP");
...
assert.match(home, /c64-dungeon-carnage-home-v2\.webp\?v=20260922-owner-preview/, "Home CTA must cache-bust the supplied Dungeon Carnage WebP");
