...
assert.match(dungeon, /data-ccg-play-maintenance-gate="owner-preview"/);
...
assert.match(ownerGate, /profile\.is_admin === true/);
assert.match(ownerGate, /profile\.banned !== true/);
...
assert.match(home, /c64-dungeon-carnage-home-v2\.webp\?v=20260922-owner-preview/);
