...
Public itch.io page creation, artifact upload/publication, browser launch verification and the final public URL remain external release actions. Do not invent an itch.io URL in source. The post-#2185 production smoke is verified green against deployed runtime `073ee3df35cd3982ceb04676619792d69a28e0e3` (run `35414519454`). Do not publish until the current startup, sustained-Solo and Banishment-Flask hands-on gates pass.
...
- 2026-09-19: #2185 merged as `073ee3df35cd3982ceb04676619792d69a28e0e3`, correcting stale-browser visible badge ownership during scheduled V10.42 bootstrap restamps. Package workflow run `35414519473` produced the new runtime publication candidate `10575312850` / SHA-256 `6425e7f4cdd296843911c78e81a1545c661123bab726c4b2cdd9449d7334d73c`. Production smoke run `35414519454`, Pages deployment and live navigation passed. External itch.io publication remains blocked only by the documented hands-on Dungeon gates.
