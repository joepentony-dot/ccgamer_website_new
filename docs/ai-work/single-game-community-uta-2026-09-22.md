...
The completed residual classification is recorded in `data/uta-residual-review-2026-09-23.json`. Every one of the 164 baseline unmatched slugs appears exactly once. The current disposition is 16 verified additional tape pages, 4 catalogue-metadata corrections, 11 different-C64-version/game collisions, and 133 records with no verified compatible UTA directory. The last category means no compatible UTA directory was verified for the exact catalogue identity; it does not imply that no commercial cassette ever existed. The review retains reason subtypes for known disk-only, cartridge-only, modern non-tape and commercial-cassette-but-absent-from-UTA cases.

The comparison identified 16 additional same-game pages covering 19 cassette releases that are safe to expose after qualification: Action Biker [6254], Barbarian II: The Dungeon of Drax [5918], Boulder Dash [411], By Fair Means or Foul / Pro Boxing Simulator [2952], Dragon's Lair II: Escape from Singe's Castle [395] and [5078], Give My Regards to Broad Street [8446], International Soccer [3215], Leader Board [6678], Live and Let Die [2954], Nebulus [6721], Nightbreed: The Action Game [1544], Ninja [2849], Spy vs Spy II: The Island Caper [3935] plus its independently matched Hi-Tec release [1987], Strip Poker: A Sizzling Game of Chance [7489] and [513], Super Pipeline / Pipeline [6490], and The Sword of Fargoal [7724]. Where UTA uses a materially different name, the alias is scoped to the exact game slug and archive ID. The curated evidence file now contains 31 games / 34 curated IDs in total; the Hi-Tec Spy vs Spy II release remains automatic because the existing `games.json` re-release evidence should match it once duplicate archive IDs are preserved.
