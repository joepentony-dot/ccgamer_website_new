...
- Re-audited: 2026-09-16 against live GitHub after #2101 and #2100 were already on `main`.
...
- Open pull requests: 55 after draft #2105 was opened as the current-main refresh of stale #2073.
...
| Content publishing and game music | [content-publishing-and-music.md](ai-work/content-publishing-and-music.md) | #2103 remains the current Worker-route PR; draft #2105 is the current-main 3D-box optimiser refresh and supersedes stale #2073 once qualified |
