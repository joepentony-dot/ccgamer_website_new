...
- Latest verified Dungeon runtime merge checkpoint is now #2205: exact qualified head `dac8819a646dfd9ec0e0669f669903157a280ff6`, merged as `eb25ee72f9c8f2d409e3b8ea7be9ec69240c8f89`. It preserves the #2201 mobile trap/menu repairs and follows #2203's initial 1.3x camera with the user-requested 1.6x mobile Solo/Tutorial renderer camera; desktop and local 2P remain at 1x. Build/cache advance to `V10.42 r38` / `20260921r38`.
