...
- Latest verified Dungeon runtime merge checkpoint remains `992d19d39cd5ad7d5fb12116dda03d80df623e61`, the merge of #2193 from exact qualified head `03333f6e89381e018197b990664a1e25205e8f78`. Test/documentation follow-ups have since advanced live `main`: #2194 merged as `28f0815f9e849090783cd78792c26fcdc8cc5cb9`, #2198 merged as `301afdfe9e39ea2551486c5857260cc607d8a038`, and startup-transition guard #2199 merged as `c0b8eb4a82806d524ce48e97c70888b09b0c327a`. None of #2194/#2198/#2199 changed Dungeon runtime/gameplay ownership.
...
- Startup/first-visual runtime remediation remains repository-complete through #2185, with the deployed production-smoke contract strengthened by #2199 on current main. Hands-on startup acceptance is still required because automated rendered-frame sampling does not replace the user-visible acceptance gate.
...
1. On the deployed build carrying the #2193 runtime, require a direct loader → final V10.42 menu transition with no compact/intermediate flash and no loader → page → loader pulse.
...
| --- | --- | --- |
| Dungeon Carnage runtime | [dungeon-carnage-runtime.md](ai-work/dungeon-carnage-runtime.md), [#2129 live regression checkpoint](ai-work/dungeon-carnage-live-freeze-cache-2026-09-17.md), and [startup/first-visual checkpoint](ai-work/dungeon-carnage-startup-first-visual-2026-09-18.md) | Runtime remains merged through #2193 at `992d19d39cd5ad7d5fb12116dda03d80df623e61`; test/documentation follow-ups #2194, #2198 and #2199 are merged through live main `c0b8eb4a82806d524ce48e97c70888b09b0c327a`. #2198 corrected the active-trap regression probe and #2199 strengthened rendered-frame startup smoke coverage; neither changed runtime. Four hands-on product gates remain: startup, sustained Solo, Banishment Flask exchange, and natural mobile spike/fire/shock damage with armour preserved. |
