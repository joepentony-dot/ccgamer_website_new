...
| --- | --- | --- |
| Dungeon Carnage runtime | [dungeon-carnage-runtime.md](ai-work/dungeon-carnage-runtime.md) | #2102, #2113 and #2115 are **MERGED**. Retained local gameplay is separated, obsolete online packet/world-sync runtime is retired, and the supported Split Screen full map is restored. The bounded retired-mode residue audit is complete; manual #2090 held-fire/Flask acceptance remains, followed by a small current-main startup/menu presentation reconstruction. |
