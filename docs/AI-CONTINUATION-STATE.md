...
- Latest verified Dungeon runtime merge checkpoint is now #2203: exact qualified head `8e1a18f6ec961cf44fe19800559e91154276ac8d`, merged as `1d875085c07f366561f4ae0dae5c3a8bbcda3019`. It preserves the #2201 mobile trap/menu repairs and adds a mobile-only 1.3x Solo/Tutorial renderer camera so the dungeon uses more of the available playfield; desktop and local 2P remain at 1x. Build/cache advance to `V10.42 r37` / `20260921r37`.
...
- Latest qualified runtime/package artifact: `C64-Dungeon-Carnage-Itch`, artifact ID `10618406437`, 21,113,481 bytes, GitHub Actions SHA-256 `e75dca59819835981adea585def7beccd90d852cd326420eb529a7ebece00b71`, workflow run `35550857671`, exact source head `8e1a18f6ec961cf44fe19800559e91154276ac8d`, merged by #2203 as `1d875085c07f366561f4ae0dae5c3a8bbcda3019`.
...
- #2203 addresses the user-reproduced mobile playfield underuse by applying a renderer-only 1.3x camera in mobile Solo/Tutorial when the canvas is 900px wide or narrower. Desktop and local split-screen remain 1x. Exact-head Site Safety, SEO, structured/social metadata, itch.io package, cache/version, dedicated mobile trap/layout, native mouse-wheel, canonical/Node and all six Chromium shards passed.
...
1. On the deployed build carrying #2203, require a direct loader → final V10.42 menu transition with no compact/intermediate flash and no loader → page → loader pulse; confirm the mobile landing cards occupy the available menu width and mobile Solo/Tutorial uses the larger 1.3x playfield.
...
| --- | --- | --- |
| Dungeon Carnage runtime | [dungeon-carnage-runtime.md](ai-work/dungeon-carnage-runtime.md), [#2129 live regression checkpoint](ai-work/dungeon-carnage-live-freeze-cache-2026-09-17.md), and [startup/first-visual checkpoint](ai-work/dungeon-carnage-startup-first-visual-2026-09-18.md) | Runtime is merged through #2203 at `1d875085c07f366561f4ae0dae5c3a8bbcda3019` from exact qualified head `8e1a18f6ec961cf44fe19800559e91154276ac8d`. #2203 preserves #2201's mobile trap/menu repairs and adds a mobile-only 1.3x Solo/Tutorial camera while desktop/local 2P remain 1x. Six hands-on checks remain: startup, sustained Solo, Banishment Flask exchange, natural mobile spike/fire/shock damage with armour preserved, full-width mobile landing-menu presentation, and larger mobile playfield acceptance. |
