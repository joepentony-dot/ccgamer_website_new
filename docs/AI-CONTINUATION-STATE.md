...
| --- | --- | --- |
| Dungeon Carnage runtime | [dungeon-carnage-runtime.md](ai-work/dungeon-carnage-runtime.md), [#2129 live regression checkpoint](ai-work/dungeon-carnage-live-freeze-cache-2026-09-17.md), and [startup/first-visual checkpoint](ai-work/dungeon-carnage-startup-first-visual-2026-09-18.md) | Runtime is merged through #2193 at `992d19d39cd5ad7d5fb12116dda03d80df623e61`; documentation/test-probe reconciliation #2194 is merged as `28f0815f9e849090783cd78792c26fcdc8cc5cb9`. Exact #2193 runtime qualification and exact #2194 reconciliation qualification are green after the documented unchanged shard retry. Four hands-on product gates remain: startup, sustained Solo, Banishment Flask exchange, and natural mobile spike/fire/shock damage with armour preserved. |
