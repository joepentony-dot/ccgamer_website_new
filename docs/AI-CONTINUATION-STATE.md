...
- Live repository `main`: `a281d4f620f267f67a8118bf469654d8273ec065`, the merge of #2192 from exact qualified head `26ad5b4e3ca67c8480257479b46f587a21d8f66d`. #2192 is the final bounded mobile floor-trap follow-up after #2188: it makes the canonical `triggerTrap()` boundary hand any already-validated active contact that survived the normal damage path to one retained R19 guarantee API, without re-sampling the trap phase clock.
...
- #2190 merged as `fab013b320ebdb1d9f2cb873ad26a3588f565655`, making Tutorial mandatory for first-time Solo players with an explicit skip path and removing the mobile Training Control obstruction from the D-pad.
- #2188 merged as `55fdc887bc05faec139b80a2567411b5c4339201` from exact head `57cdb1c24ec09bc266fcfebd3492fcfa3d9ed487`, establishing the real-touch natural-trap regression and initial synchronous repair. Repeated exact-main qualification then exposed an intermittent wrapper/phase-edge race, so #2192 supersedes #2188 as the final repository checkpoint for this defect.
- #2192 merged as `a281d4f620f267f67a8118bf469654d8273ec065` from exact head `26ad5b4e3ca67c8480257479b46f587a21d8f66d`. Its four-file delta is limited to canonical `triggerTrap()` handoff, the existing R19 mobile-trap owner, the real-touch natural-trap browser regression and the static R19 contract. Exact-head qualification passed CCG Site Safety, SEO Automation, itch.io package, Public Code Cache Version, Native Mouse Wheel Scroll Contract, the dedicated Mobile Trap Layout workflow, canonical/Node, discovery and all six Load Safety Chromium shards. Naturally generated fire/spike/shock contacts remove exactly one HP, preserve armour and do not award progression XP; already-validated active contacts are no longer dropped by a later phase-clock recheck.
- Latest qualified runtime/package artifact: `C64-Dungeon-Carnage-Itch`, artifact ID `10611582223`, 21,112,558 bytes, GitHub Actions SHA-256 `336c251ede6183f73a3469e5beaa4dca8a176349aa3fd0da86ea10eb6eb50235`, workflow run `35532598361`, exact source head `26ad5b4e3ca67c8480257479b46f587a21d8f66d`, merged by #2192 as current main `a281d4f620f267f67a8118bf469654d8273ec065`.
...
1. On deployed current main `a281d4f620f267f67a8118bf469654d8273ec065`, require a direct loader → final V10.42 menu transition with no compact/intermediate flash and no loader → page → loader pulse.
...
| --- | --- | --- |
| Dungeon Carnage runtime | [dungeon-carnage-runtime.md](ai-work/dungeon-carnage-runtime.md), [#2129 live regression checkpoint](ai-work/dungeon-carnage-live-freeze-cache-2026-09-17.md), and [startup/first-visual checkpoint](ai-work/dungeon-carnage-startup-first-visual-2026-09-18.md) | Runtime is merged through #2185; current main is `073ee3df35cd3982ceb04676619792d69a28e0e3`. Exact-head qualification, deployed production smoke, live navigation and push Load Safety (after one unchanged shard-3 stability retry) are green. Only the three documented hands-on product gates remain. |
