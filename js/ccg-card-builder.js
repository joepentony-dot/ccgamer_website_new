    ...
    return `
        <div class="ccg-game-card genre-card">
            <a href="${gameUrl}" class="ccg-game-card__thumb">
                <img src="${thumb}" srcset="${thumb} 320w, ${thumb} 640w" sizes="(max-width: 720px) 48vw, (max-width: 1200px) 240px, 320px" alt="${title}" loading="lazy" decoding="async" width="320" height="180">
                ${ratingMarkup}
            </a>
