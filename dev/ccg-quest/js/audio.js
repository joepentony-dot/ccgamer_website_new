window.CCGSound=(()=>{
  ...
  function sfx(name){
    ...
    const f={
      ...
      bronze:()=>{tone(310,.06,"square",.09,100);tone(510,.08,"triangle",.08,130,.05)},
      door:()=>{tone(110,.12,"square",.08,-20);tone(260,.12,"triangle",.07,120,.08)},
      locked:()=>{tone(82,.05,"square",.07,-5);tone(82,.05,"square",.05,-5,.08)},
      weapon:()=>{tone(350,.06,"square",.10,260);tone(700,.09,"square",.08,150,.05)},
      armour:()=>{tone(180,.08,"triangle",.08,80);tone(270,.11,"triangle",.07,40,.06)},
      potion:()=>{tone(520,.08,"sine",.08,-80);tone(690,.08,"sine",.06,90,.06)},
      torch:()=>{noise(.06,.025);tone(220,.12,"triangle",.06,100)},
      room:()=>{tone(260,.05,"triangle",.04,60);tone(390,.07,"triangle",.035,-40,.04)},
