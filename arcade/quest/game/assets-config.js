(function(){
  ...
  const ASSET_REVISION='v20260825-q2b';
  ...
  Q.CUSTOM_ASSETS={
    ...
    spritesheets:{player:production('player/cheeky-main-v2.svg'),playerFight:production('player/cheeky-fight-v2.svg'),fighter:production('fighter/retsu-sheet.png'),enemy:production('enemies/8bit-enemy-sheet.png'),bossBedroom:production('bosses/bedroom-sheet.png'),bossBudget:production('bosses/budget-sheet.png'),bossChristmas:production('bosses/christmas-sheet.png'),bossAmiga:production('bosses/amiga-sheet.png'),bossGuru:production('bosses/guru-sheet.png')},
  ...
  const mainState={
    idle:{drawWidth:156,drawHeight:198,offsetY:0,hitbox:{x:13,y:25,w:52,h:107}},run:{drawWidth:164,drawHeight:202,offsetY:0,hitbox:{x:12,y:25,w:54,h:107}},jumpTakeoff:{drawWidth:160,drawHeight:202,offsetY:0,hitbox:{x:13,y:26,w:52,h:104}},jumpRise:{drawWidth:162,drawHeight:206,offsetY:-3,hitbox:{x:13,y:23,w:52,h:103}},jumpApex:{drawWidth:164,drawHeight:205,offsetY:-4,hitbox:{x:13,y:22,w:52,h:101}},jump:{drawWidth:164,drawHeight:205,offsetY:-4,hitbox:{x:13,y:22,w:52,h:101}},fall:{drawWidth:162,drawHeight:204,offsetY:-2,hitbox:{x:13,y:24,w:52,h:103}},land:{drawWidth:162,drawHeight:184,offsetY:8,hitbox:{x:12,y:44,w:54,h:88}},duck:{drawWidth:174,drawHeight:126,offsetY:66,hitbox:{x:7,y:70,w:64,h:62},muzzle:{x:76,y:86}},duckFire:{drawWidth:188,drawHeight:128,offsetY:64,hitbox:{x:7,y:68,w:64,h:64},muzzle:{x:82,y:87}},fire:{drawWidth:178,drawHeight:198,offsetY:0,hitbox:{x:12,y:25,w:54,h:107},muzzle:{x:74,y:58}},hit:{drawWidth:170,drawHeight:198,offsetY:0,hitbox:{x:12,y:25,w:54,h:107}},victory:{drawWidth:170,drawHeight:212,offsetY:-10,hitbox:{x:12,y:20,w:54,h:108}}
  };
  const fightState={
    idle:{drawWidth:238,drawHeight:302,offsetY:0,hitbox:{x:-45,y:-260,w:90,h:250}},walk:{drawWidth:238,drawHeight:302,offsetY:0,hitbox:{x:-45,y:-260,w:90,h:250}},jump:{drawWidth:238,drawHeight:302,offsetY:0,hitbox:{x:-45,y:-255,w:90,h:245}},guard:{drawWidth:238,drawHeight:294,offsetY:8,hitbox:{x:-48,y:-245,w:96,h:235}},duck:{drawWidth:252,drawHeight:198,offsetY:104,hitbox:{x:-58,y:-150,w:116,h:140}},punch:{drawWidth:260,drawHeight:302,offsetY:0,hitbox:{x:-45,y:-260,w:90,h:250}},kick:{drawWidth:276,drawHeight:302,offsetY:0,hitbox:{x:-45,y:-260,w:90,h:250}},hit:{drawWidth:248,drawHeight:302,offsetY:0,hitbox:{x:-45,y:-260,w:90,h:250}},victory:{drawWidth:250,drawHeight:314,offsetY:-12,hitbox:{x:-45,y:-260,w:90,h:250}}
  };
  ...
  Q.CUSTOM_ASSET_META={
    ...
    'spritesheets:playerFight':{frameWidth:248,frameHeight:316,columns:4,fps:8,drawWidth:238,drawHeight:302,avatarHead:false,animations:{idle:[0,1],walk:[2],run:[2],guard:[3],duck:[4],punch:[5],kick:[6],hit:[7],victory:[8],jump:[9]},loop:true,stateMeta:fightState},
