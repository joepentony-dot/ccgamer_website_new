...
assert.match(index,/v10-41-r26-spy-enemy-stability\.js\?v=20260825r28/,"canonical page must retain the r26 stability hotfix under the current r28 cache shell");
...
console.log("Lost Sizzler r26 Spy movement and Solo enemy stability compatibility checks passed under the r28 cache shell.");
