...
assert.doesNotMatch(guard,/data-release-ready="true"/,"legacy readiness must not bypass the authoritative V10.42 loader owner");
...
assert.match(guard,/display:none!important/,"active gameplay must deterministically hide a stale release overlay");
