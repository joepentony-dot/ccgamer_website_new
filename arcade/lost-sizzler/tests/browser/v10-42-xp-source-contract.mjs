...
try{
  ...
  await page.waitForFunction(()=>document.body.dataset.gameReady==="true"&&Boolean(window.CCGLostSizzlerXPSourceContract)&&Boolean(document.getElementById("solo-btn")),null,{timeout:90000});
  ...
  await context.close();
  console.log("Door/switch XP is blocked while canonical combat XP remains live.");
}finally{
