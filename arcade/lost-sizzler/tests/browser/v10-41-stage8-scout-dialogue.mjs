...
try{
  ...
  const first=await page.evaluate(()=>{
    ...
    const reAdopted=Boolean(window.triggerRescue?.__ccgStage8NpcDialogue)&&window.triggerRescue!==lateCanonicalOwner&&api.state.reAdoptions===reAdoptionsBefore+1;
