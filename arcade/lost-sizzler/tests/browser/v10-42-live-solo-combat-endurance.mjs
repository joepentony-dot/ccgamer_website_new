...
try{
  ...
  assert.ok(boot.ordered.every(src=>new URL(src).searchParams.get("v")==="20260921r38"),"every ordered V10.42 module must use the r36 cache token");
  assert.ok(v142Requests.some(src=>src.includes("v10-42-projectile-lifecycle.js?v=20260921r38")),"expected r36 projectile lifecycle asset was not requested");
