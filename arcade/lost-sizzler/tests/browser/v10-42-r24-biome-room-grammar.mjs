...
try{
  ...
  console.log(`C64 Dungeon Carnage V10.42 R24 biome room-grammar qualification passed: ${JSON.stringify({rooms:result.liveRooms.length,identities:result.samples.map(sample=>sample.biomeIdentity)})}`);
  await context.close();
}finally{
  await browser.close();
