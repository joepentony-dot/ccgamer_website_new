...
assert.ok(releaseToken,"the canonical Lost Sizzler page must expose a release cache token");
assert.ok(index.includes(`/js/ccg-supabase-client.js?v=${releaseToken}`),"the multiplayer client must use the canonical release cache token");
