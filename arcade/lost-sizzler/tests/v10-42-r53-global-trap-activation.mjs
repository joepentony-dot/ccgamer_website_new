...
assert.match(systems,/hazardReserveCandidates=[\s\S]*hazardReservePreferred=[\s\S]*hazardReserveSupplemental=[\s\S]*hazardReserveRooms=\[\.\.\.hazardReservePreferred,\.\.\.hazardReserveSupplemental\]/,"compact floors must supplement mandatory hazard reservation from haunted-corridor candidates rather than dropping the required hazard");
