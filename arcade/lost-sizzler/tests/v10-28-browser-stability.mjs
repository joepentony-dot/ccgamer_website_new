...
try{
...

  {
    ...
    await state.page.locator("#ccg-tutorial-stage-modal [data-stage-continue]").click({noWaitAfter:true});
    ...
    for(let step=4;step<=8;step++){
      ...
      await state.page.locator("#ccg-tutorial-info-tour [data-tour-continue]").click({noWaitAfter:true});
