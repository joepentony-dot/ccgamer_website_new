...
assert.match(loader,/const CCG_DOSSIER_REV=CCG_RELEASE_REV;/,"dossier enhancement must inherit the canonical published release token");
assert.match(loader,/v10-6-dossier-polish\.js\?v=\$\{CCG_DOSSIER_REV\}/,"dossier enhancement URL must be cache-busted with that release token");
