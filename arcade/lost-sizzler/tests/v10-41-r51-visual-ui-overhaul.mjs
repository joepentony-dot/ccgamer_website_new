...
const focus=fs.readFileSync(path.join(root,"js/v10-41-r51-menu-focus-polish.js"),"utf8");
...
assert.match(loader,/v10-41-r51-menu-focus-polish\.js/);
...
assert.match(src,/v141R47PerformanceTier/,"R51 presentation must obey the established R47 performance governor");
...
assert.match(focus,/focusin/);
assert.match(focus,/scrollIntoView/);
assert.match(focus,/block:"nearest"/);
assert.match(focus,/ccg-reduced-motion/);
...
console.log("Lost Sizzler V10.41 r51 visual/UI ownership, adaptive performance and usability contract passed.");
