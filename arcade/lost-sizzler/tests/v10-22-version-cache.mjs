...
assert.equal(manifest.build,"V10.42 r35","current published build must remain explicit in the regression check");
assert.equal(manifest.cacheToken,"20260919r35","current release cache token must remain explicit in the live manifest");
