...
assert.equal(manifest.build,"2026.08.24.5","current published build must be explicit in the regression check");
assert.equal(manifest.cacheToken,"20260824r5","current release cache token must be explicit in the live manifest");
...
assert.match(index,/js\/v10-23-tutorial-guidance\.js\?v=20260824d/,"r5 must use the current tutorial launcher revision");
assert.ok(index.indexOf("js/v10-23-tutorial-guidance.js?v=20260824d")<index.indexOf("js/asset-overrides.js?v=20260824r5"),"tutorial launch guidance must load before the enhancement queue");
...
console.log("Lost Sizzler r5 build, V10.32 cache refresh, canonical home recognition and scroll-safety regression checks passed.");
