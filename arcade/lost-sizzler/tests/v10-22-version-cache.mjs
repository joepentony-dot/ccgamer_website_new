...
assert.equal(manifest.build,"V10.42 r44","current published build must remain explicit in the regression check");
assert.equal(manifest.cacheToken,"20260921r44","current release cache token must remain explicit in the live manifest");
