...
assert.equal(manifest.build,"V10.42 r51","current published build must remain explicit in the regression check");
assert.equal(manifest.cacheToken,"20260923r51","current release cache token must remain explicit in the live manifest");
