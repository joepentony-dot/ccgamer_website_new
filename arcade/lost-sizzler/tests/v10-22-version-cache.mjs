...
assert.equal(manifest.build,"V10.42 r54","current published build must remain explicit in the regression check");
assert.equal(manifest.cacheToken,"20260924r54-critical3","current release cache token must remain explicit in the live manifest");
...
assert.match(homeScript,/arcade\/c64-dungeon-carnage\/assets\/lost-sizzler\.webp/,"home-page mark must reuse canonical artwork");
