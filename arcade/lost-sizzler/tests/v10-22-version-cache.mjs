...
assert.equal(manifest.build,"V10.42 r55","current published build must remain explicit in the regression check");
assert.equal(manifest.cacheToken,"20260924r55","current release cache token must remain explicit in the live manifest");
