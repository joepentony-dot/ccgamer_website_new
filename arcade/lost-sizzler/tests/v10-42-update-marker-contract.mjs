...
assert.equal(version.build, 'V10.42 r40');
assert.equal(version.cacheToken, '20260921r40');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r40"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260921r40"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260921r40');
