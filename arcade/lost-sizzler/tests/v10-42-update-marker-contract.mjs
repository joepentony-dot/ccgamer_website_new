...
assert.equal(version.cacheToken, '20260923r51');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r51"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260923r51"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260923r51');
