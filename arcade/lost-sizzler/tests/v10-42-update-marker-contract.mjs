...
assert.equal(version.build, 'V10.42 r49');
assert.equal(version.cacheToken, '20260922r49');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r49"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260922r49"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260922r49');
