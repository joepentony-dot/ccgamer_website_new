...
assert.equal(version.cacheToken, '20260919r36');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r36"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260919r36"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260919r36');
