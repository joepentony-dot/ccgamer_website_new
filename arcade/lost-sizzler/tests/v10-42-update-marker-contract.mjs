...
assert.equal(version.build, 'V10.42 r33');
assert.equal(version.cacheToken, '20260918r33');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r33"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260918r33"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260918r33');
