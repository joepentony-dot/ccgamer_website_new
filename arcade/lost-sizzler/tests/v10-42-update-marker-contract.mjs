...
assert.equal(version.build, 'V10.42 r46');
assert.equal(version.cacheToken, '20260921r46');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r45"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260921r46"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260921r46');
