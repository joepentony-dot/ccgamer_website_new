...
assert.equal(version.build, 'V10.42 r32');
assert.equal(version.cacheToken, '20260918r32');
assert.match(index, /meta name="ccg-lost-sizzler-build" content="V10\.42 r31"/);
assert.match(index, /meta name="ccg-lost-sizzler-cache" content="20260918r32"/);
...
const versionCheckIndex = index.indexOf('js/version-check.js?v=20260918r32');
