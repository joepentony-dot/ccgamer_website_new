...
assert.equal(version.build,"V10.42 r53","the retained unused level-up feature must remain present under the current r53 build identity");
assert.equal(version.cacheToken,"20260923r53","the retained unused level-up feature must follow the current release-wide cache token");
