...
assert.equal(version.build,"V10.42 r58","the retained unused level-up feature must remain present under the current r55 build identity");
assert.equal(version.cacheToken,"20260925r58","the retained unused level-up feature must follow the current release-wide cache token");
