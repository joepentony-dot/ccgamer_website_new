...
assert.equal(version.build,"V10.42 r48");
assert.equal(version.cacheToken,"20260921r48");
...
assert.ok(visual>=0&&r48>visual&&tutorial>r48,"r48 portal presentation must wrap the final visual renderer before later gameplay-support modules");
...
console.log("Dungeon Carnage r48 elemental portal presentation contract passed.");
