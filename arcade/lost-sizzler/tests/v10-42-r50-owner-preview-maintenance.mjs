...
assert.match(index,/ccg-play-maintenance-owner-gate\.js\?v=20260924r55/,"Dungeon page must load the shared owner-preview gate under the current cache token");
