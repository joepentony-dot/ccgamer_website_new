...
assert.equal(buildMeta,BUILD,"the blocking page identity must already be the current r56 build before any runtime restamp");
...
for(const asset of localAssets)assert.equal(asset.token,CACHE,`${asset.url} is not pinned to the current r56 cache token`);
...
console.log("Dungeon Carnage r56 blocking release/cache identity contract passed.");
