...
assert.match(bootstrap,/const CACHE="20260922r50";/,"ordered bootstrap cache identity changed unexpectedly");
...
assert.match(html,/game-local-runtime\.js\?v=20260922r50/,"the extracted current local runtime must not remain under the obsolete September 10 cache key");
assert.match(html,/game-main\.js\?v=20260922r50/,"the current input/frame owner must not remain under the obsolete September 10 cache key");
assert.match(html,/v10-41-cache-guard\.js\?v=20260922r50/,"the cache guard itself must be fetched under the current release token");
