...
assert.match(bootstrap,/const BUILD="V10\.42 r53";/,"ordered bootstrap build identity changed unexpectedly");
...
assert.match(bootstrap,/v10-42-stage6-zone-gameplay\.js/,"r53 must load the Stage 6 zone gameplay owner through the ordered bootstrap");
