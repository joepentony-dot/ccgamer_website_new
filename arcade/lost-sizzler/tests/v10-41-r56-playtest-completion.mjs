...
assert.match(r56,/const running=\(\)=>\{[\s\S]*run&&host&&p1[\s\S]*dataset\.runActive="true"/,'legacy combat repair must recover a stale presentation flag while a real dungeon run still exists');
