...
assert.match(index,/v10-23-tutorial-guidance\.js\?v=20260825r20/,"the release must directly load the fullscreen-safe tutorial launcher with the current r20 token");
