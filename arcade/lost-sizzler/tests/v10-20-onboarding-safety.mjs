...
assert.match(index,/v10-23-tutorial-guidance\.js\?v=20260825r29/,"the release must directly load the fullscreen-safe tutorial launcher with the current r29 token");
