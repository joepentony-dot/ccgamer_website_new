...
assert.match(index,/v10-23-tutorial-guidance\.js\?v=20260825r28/,"the release must directly load the fullscreen-safe tutorial launcher with the current r28 token");
...
console.log("Lost Sizzler r28 tutorial regression checks passed: static Tutorial option, one start menu, async mobile launch persistence, centred acknowledgement cards and real control input.");
