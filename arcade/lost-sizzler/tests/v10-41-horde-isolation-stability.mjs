...
assert.equal(manifest.build,"2026.08.25.27","Horde stability fixes must remain published in build .27");
assert.equal(manifest.cacheToken,"20260825r27","Horde stability fixes must use the r27 cache shell");
