...
assert.match(stallElapsed,/if\(crossedPauseBoundary\)[\s\S]*last=t-NORMAL_FRAME_MS/,"the authoritative loop handoff must rebase its frame clock to one normal step when play resumes from a pause boundary");
