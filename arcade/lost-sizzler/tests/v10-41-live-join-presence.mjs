...
assert.equal(version.build,"2026.08.26.30","live-join protection must remain included in the current r29 build");
assert.equal(version.cacheToken,"20260826r30","live-join protection must remain included in the current r29 cache generation");
assert.match(index,/js\/network\.js\?v=20260826r30/,"published page must keep browsers on the current r29 network runtime");
...
console.log("Lost Sizzler V10.41 persistent live multiplayer late-join regression checks passed under r29.");
