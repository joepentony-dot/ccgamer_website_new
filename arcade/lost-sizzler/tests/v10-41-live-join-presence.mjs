...
assert.equal(version.build,"2026.08.25.22","live-join protection must remain included in the current r22 build");
assert.equal(version.cacheToken,"20260825r22","live-join protection must remain included in the current r22 cache generation");
assert.match(index,/js\/network\.js\?v=20260825r22/,"published page must keep browsers on the current r22 network runtime");
