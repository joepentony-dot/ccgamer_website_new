...
assert.equal(version.build,"2026.08.25.21","live-join protection must remain included in the current r21 build");
assert.equal(version.cacheToken,"20260825r21","live-join protection must remain included in the current r21 cache generation");
