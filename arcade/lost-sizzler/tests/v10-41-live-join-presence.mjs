...
assert.equal(version.build,"2026.08.25.27","live-join protection must remain included in the current r27 build");
assert.equal(version.cacheToken,"20260825r27","live-join protection must remain included in the current r27 cache generation");
assert.match(index,/js\/network\.js\?v=20260825r27/,"published page must keep browsers on the current r27 network runtime");
