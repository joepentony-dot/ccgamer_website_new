...
(()=>{
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      /* Major gameplay notifications use the reserved message rail and never cover the dungeon canvas. */
      ...
      @media(max-width:760px){body[data-run-active="false"] #menu .game-mode-buttons{grid-template-columns:1fr 1fr!important}body[data-run-active="false"] #menu #solo-btn,body[data-run-active="false"] #menu #create-btn{grid-column:span 1!important}body[data-run-active="false"] #menu #horde-solo-btn,body[data-run-active="false"] #menu #horde-mode-btn,body[data-run-active="false"] #menu #saboteurs-mode-btn,body[data-run-active="false"] #menu #split-btn{grid-column:span 1!important}body[data-run-active="false"] #menu .feature-strip{grid-template-columns:1fr!important}#ccg-major-notification{grid-template-columns:30px minmax(0,1fr);gap:7px;width:100%;min-height:68px;max-height:86px;padding:7px 9px}#ccg-major-notification .major-icon{width:27px;height:27px;font-size:14px}.major-copy b{font-size:9px!important}.major-copy span{max-height:50px;font-size:7px!important}}
    `;
