...
(function(){
  ...
  function runMeta(){return{roomCode:net.roomCode,seed:net.roomCode,floor:1,difficulty:UI.difficulty?.value||"ARCADE",modifier:null,startedAt:Date.now(),build:"V10.31"}}
