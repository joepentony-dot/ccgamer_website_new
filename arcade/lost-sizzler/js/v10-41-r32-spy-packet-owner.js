...
(()=>{
  ...
  const state={timer:0,adopted:false,r32Packet:null,normalBase:null,spyCompositions:0,normalRestores:0,lastMode:false};
  ...
  window.CCGLostSizzlerV141R32SpyPacketOwner={capture,adoptR32Maintenance,composeSpy,restoreNormal,get state(){return state}};
})();