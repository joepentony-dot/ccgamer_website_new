...
(()=>{
  ...
  function authoritativeOffer(value){
    const offer=value?.offer||value||{};const currency=String(offer.currency||"GBP").toUpperCase(),amount=String(offer.display_price||offer.displayPrice||offer.price_display||"").trim();
  ...
  function ensureStyle(){
    ...
    const style=document.createElement("style");style.id="v142-demo-paywall-style";style.textContent=`
      ...
      body[data-v142-demo-locked="true"] #solo-btn,body[data-v142-demo-locked="true"] #create-btn,body[data-v142-demo-locked="true"] #horde-mode-btn,body[data-v142-demo-locked="true"] #saboteurs-mode-btn,body[data-v142-demo-locked="true"] #split-btn,body[data-v142-demo-locked="true"] #daily-btn{filter:saturate(.35);opacity:.68}
