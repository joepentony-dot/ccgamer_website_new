...
(()=>{
  ...
  function enhanceMenu(){
    ...
    if(!document.getElementById("ccg-r51-menu-guide")){
      const guide=document.createElement("div");guide.id="ccg-r51-menu-guide";guide.setAttribute("aria-label","Menu quick guide");guide.innerHTML="<span><b>SOLO</b> saves locally + cloud when signed in</span><span><b>TUTORIAL</b> teaches controls, combat, items and objectives</span><span><b>CONTROLLER</b> D-pad/stick + A works in menus</span><span><b>OPTIONS</b> accessibility and audio are stored in this browser</span>";
