...
(()=>{
  ...
  function loadSpyR32(){if(!window.CCGLostSizzlerV141R32SpyOverhaul)loadScript("v10-41-r32-spy-overhaul.js","data-ccg-r32-spy-overhaul")}
  function loadSpyR32PacketOwner(){if(!window.CCGLostSizzlerV141R32SpyPacketOwner)loadScript("v10-41-r32-spy-packet-owner.js","data-ccg-r32-spy-packet-owner")}
  loadOwnerSeal();loadModeRuntime();loadSpyExitControlReset();loadSoloDungeonR31();loadSpyR32WorldOwner();loadSpyR32();loadSpyR32PacketOwner();
