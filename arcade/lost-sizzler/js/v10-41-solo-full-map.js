/* The Lost Sizzler V10.41 — full-level explored map for Solo and local split-screen. */
(()=>{
  "use strict";
  ...
  function openMap(){
    ...
    clearMovementState();
    // Every mode except "playing" freezes the loop. A dedicated map mode must
    // not be mistaken for an orphaned pause by the later recovery layers.
