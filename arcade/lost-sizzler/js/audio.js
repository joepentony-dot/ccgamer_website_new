window.CCGSound=(()=>{
  ...
  function sfx(name){try{window.dispatchEvent(new CustomEvent("ccg:sfx",{detail:{name:String(name||""),enabled:Boolean(enabled),at:performance.now()}}))}catch(_){}if(!enabled)return;const f={
