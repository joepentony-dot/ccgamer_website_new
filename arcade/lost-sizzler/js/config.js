window.CCG_CONFIG=Object.freeze({
  ...
  followerElites:[
    ...
    {name:"AZALEA",initials:"AZ",kind:"root",hp:7,armor:4,avatar:"",musicKey:"parsnip-celery",strength:"Root projectiles pin down open lanes while AZALEA keeps pressure from range.",weakness:"Walls stop the shots; break line of sight and close from cover."},
