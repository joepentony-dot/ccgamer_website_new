  ...
  const days=[
    {
      ...
      entries:[
        ...
        ["LS-0825-03","CHANGED","Horde encounter pacing","Horde now uses a deliberately smaller centred combat arena rather than almost the entire 128×84 dungeon world, keeping perimeter pressure meaningful without making the arena cramped."],
        ["LS-0825-04","FIXED","Spy Vs Spy movement recovery","The frame-by-frame multiplayer input clear that competed with normal movement has been removed, restoring the authoritative movement and doorway-opening path instead of depending on the old emergency fallback during normal play."],
        ...
        ["LS-0825-14","FIXED","Multiplayer held-input ownership","Horde Multiplayer and Spy Vs Spy no longer erase held movement or attack input before and after every update. Multiplayer still cannot be paused, but normal input remains owned by the normal movement and combat systems."],
        ["LS-0825-15","CHANGED","Horde Survivor r28 balance","Horde uses a 94×58 combat arena. Dedicated Horde movement is slowed by 25%, every Horde enemy loses one HP with a minimum of one, and every player's wave weapon fires three projectiles from Wave 1 while later-wave power progression remains intact."],
        ["LS-0825-16","FIXED","Horde lighting, HUD and aiming","Horde fog is removed and the arena receives permanent wide-area lighting. Overhead ammo text, the canvas Horde status banner and the Horde Score Saved popup are suppressed. Player diagonal fire remains available while enemy projectiles are restricted to horizontal or vertical lanes."],
        ["LS-0825-17","FIXED","Spy Vs Spy notification boundary","While Spy Vs Spy is active, ordinary Dungeon bounties, mutations, Stalker, Sigil, Sanctuary, inventory and other Solo-only notices are rejected, and an already-visible Dungeon notification is removed when Spy starts."],
        ["LS-0825-18","CHANGED","Spy searchable furniture","Normal Spy rooms now hold four searchable furniture objects with at least two bookcases and occasional third bookcases. Search furniture is positioned toward the walls, kept away from door approaches and room centres, and remains indestructible."],
        ["LS-0825-19","CHANGED","Joystick Hunter floor progression","Ordinary Joystick Hunters now scale across the five-floor run: Floor 1 is substantially easier, Floor 2 easier, Floor 3 moderate, Floor 4 tough and Floor 5 toughest. Named follower enemies that use Hunter AI are excluded."],
        ["LS-0825-20","FIXED","Large desktop and 1440p scaling","The late 1480-pixel outer-shell width cap has been removed for large displays, allowing the existing responsive canvas system to use the available 1440p desktop viewport instead of leaving large unused black margins."],
        ["LS-0825-21","ADDED","Automatic latest-version prompt","The existing background version checker now has an r28 generation to compare against. Players left on an older cached build receive the automatic Update Available menu panel; refreshing through it loads the current page and the cache guard refreshes Lost Sizzler assets without deleting saves, settings or achievements."],
        ["LS-0825-22","CHANGED","r28 cache-safe delivery","Build 2026.08.25.28 uses cache generation 20260825r28 across the canonical game page and runtime assets so the special-mode, input and viewport repairs cannot be mixed with stale r27 files."]
      ]
    },
    {
      date:"24 AUGUST 2026",
  ...
  function mount(){
    ...
    details.innerHTML=`
      <summary>
        ...
        <span class="developer-changelog-latest">LATEST UPDATE · 25 AUG 2026 · V10.41 · r28</span>
      </summary>
      <div class="developer-changelog-body">
        <p class="developer-changelog-intro"><span><strong>LIVE DEVELOPMENT LOG.</strong> Confirmed player-facing fixes and substantial gameplay changes are recorded here so testers can see what changed and when.</span><time datetime="2026-08-25">Last updated 25 August 2026 · V10.41 · build 2026.08.25.28</time></p>
        ...
        <p class="developer-changelog-foot">Statuses describe the published website build: FIXED = confirmed code correction, CHANGED = deliberate behaviour or balance revision, ADDED = new capability, MONITORING = a reported issue with a mitigation deployed but still being watched.</p>
      </div>`;
