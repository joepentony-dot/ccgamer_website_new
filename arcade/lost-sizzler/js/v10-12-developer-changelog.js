  ...
  const days=[
    {
      ...
      entries:[
        ...
        ["DC-0916-11","VERIFYING","Final supported-mode release qualification","After the open firing, economy, identity and cleanup work is corrected, Solo, Tutorial, local 2P Split Screen, saves, floor transitions, progression and the Weekly Vault need a final current-production regression and hands-on acceptance pass."]
      ]
    }
  ];
