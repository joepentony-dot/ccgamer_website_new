  ...
  const days=[
    {
      ...
      entries:[
        ...
        ["DC-0916-02","OPEN","Artefact shop currency model","The current progression foundation uses Gold for ordinary shop stock. The requested final artefact-currency purchasing model is not yet implemented, so shop spending remains active work rather than a completed economy change."],
        ["DC-0916-03","PARTIAL","Retired multiplayer runtime removal","Dungeon Multiplayer, Horde and Spy entry surfaces have been retired and the online lobby markup is gone. Mixed legacy networking code still needs active Solo/local Split Screen helpers separated before the remaining online transport can be deleted safely."],
        ["DC-0916-04","PARTIAL","Five-depth biome and room identity","All five campaign depths already have distinct biome presentation. The stronger deterministic room-grammar pass remains unmerged and must be refreshed onto current main before qualification."],
        ["DC-0916-05","OPEN","Four elemental portal architecture","The requested Water, Fire, Earth and Air portal structure with distinct zone identities has not yet been implemented in the current release runtime."],
        ["DC-0916-06","OPEN","Larger procedural dungeon topology","Current biome and room-grammar layers decorate or describe the existing generated dungeon. The requested larger, grander zone topology remains a separate implementation task."],
        ["DC-0916-07","PARTIAL","NPC and merchant expansion","The deterministic NPC dialogue, rumour, rescue and quest foundation is present. Deeper merchant transactions, world integration and finished NPC content still require implementation and live qualification."],
        ["DC-0916-08","PARTIAL","Startup and menu simplification","The old unified-UI candidate never merged and is stale against current main. Its useful presentation changes need to be split into fresh, current-main stages rather than merged wholesale."],
        ["DC-0916-09","OPEN","itch.io release handoff","itch.io is the intended purchase and download route. The old PayPal-specific release path is superseded; the reusable offline package work still needs a current itch.io release handoff and end-to-end release check."],
        ["DC-0916-10","VERIFYING","Final supported-mode release qualification","After the open firing, economy and cleanup work is corrected, Solo, Tutorial, local 2P Split Screen, saves, floor transitions, progression and the Weekly Vault need a final current-production regression and hands-on acceptance pass."]
      ]
    }
  ];
