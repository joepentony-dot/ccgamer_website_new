 ...
 *
 * The overhaul has no reason to install during Solo, Horde or ordinary online
 * Dungeon sessions. Keep those startup/network paths untouched and load the
 * r32 ownership stack only after Sizzler Saboteurs is genuinely active.
 */
(()=>{
  "use strict";
