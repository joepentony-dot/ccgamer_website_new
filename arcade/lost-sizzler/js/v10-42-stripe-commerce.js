/* C64 Dungeon Carnage V10.42 — Supabase-backed Stripe commerce adapter. */
(()=>{
  "use strict";
  ...
  async function checkout(){
    ...
    if(!data.checkoutUrl)throw new Error("Secure Checkout did not return a destination");
