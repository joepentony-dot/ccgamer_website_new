 ...
 * to that shell and the no-op send/broadcast hooks still called by supported
 * local gameplay are retained here. No packet routing, remote-player simulation
 * or world-sync state is retained.
 */
