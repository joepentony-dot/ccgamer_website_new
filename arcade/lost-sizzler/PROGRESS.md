...
- Latest verified Dungeon runtime merge checkpoint: `ba75374ea45871e24885a0d2cdbd57bb61f1ae95`, the merged final-menu reveal correction (#2153) after hands-on acceptance exposed a remaining intermediate-menu flicker. Stage 8 itch.io repository preparation remains complete through #2141.
...
- Startup/first-visual remediation #2145 is merged. Exact qualified head: `432af71f6d19612a54e274f9114c6b3ef35e7450`; merge commit: `4c56d2bccd73350359c8b3246b0d70142894d353`. Hands-on acceptance later proved one remaining reveal race: the loader could hide after the legacy gate but before the authoritative V10.42 ordered bootstrap had finished composing the final five-depth/RPG menu.
- Final-menu reveal correction #2153 is merged. Exact qualified head: `8a2fc01022612a13d0c4f52f276a4d7d62deee4e`; merge commit: `ba75374ea45871e24885a0d2cdbd57bb61f1ae95`. The loader now remains visible until both legacy readiness and authoritative V10.42 ordered-bootstrap/body readiness are true. Canonical/Node, package/cache/mouse-wheel checks and all six Chromium shards passed; shard 5 used one unchanged retry for the historical `v10-35-layout.mjs` startup timeout. Qualified replacement itch.io artifact: `C64-Dungeon-Carnage-Itch`, artifact ID `10544143256`, Actions SHA-256 `8001fc1034a03051ecec70de5c0966a07429b55abd8ae7f43382eecb80576036`.
...
| Startup first-visual ownership | **REPOSITORY-COMPLETE — #2145 + #2153; MANUAL RETEST REQUIRED** | #2145 established the blocking first visual. Hands-on testing then exposed an intermediate compact-menu reveal; #2153 keeps the loader until authoritative V10.42 menu composition is complete. Exact head `8a2fc010...` passed the retained matrix and merged as `ba75374e...`. |
