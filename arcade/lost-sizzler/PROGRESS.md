...
- Latest verified Dungeon runtime merge checkpoint is #2201: exact qualified head `4fa73b27dc2f8e5216ccb326e125615169ece5c0`, merged as `f66274da6cfe6d78732fe3cda901306335ff18d7`. It repairs the deployed mobile natural-trap damage failure and the narrow left-column mobile landing presentation, and advances the cache token to `20260921r36`.
...
11. **Final qualification — EXACT-HEAD AUTOMATION PASS / HANDS-ON REQUIRED.** Repository coding is complete unless a hands-on gate exposes a new reproducible defect. Complete current startup, sustained Solo, Defect 5 Flask, mobile natural-trap damage and full-width mobile landing acceptance before external itch.io publication.
