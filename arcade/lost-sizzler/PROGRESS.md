...
- Latest verified Dungeon runtime merge checkpoint/current `main`: `4319ff84ea8bca41559347915d0ab5d2c1a0e873`, the merge of #2182 from exact qualified head `dfce128672fd90c8edf7900b3bac3a14095e58fe`. #2180 previously closed a remaining premature run/tutorial active-state loader-hide path; #2181 aligned the production smoke to `V10.42 r34` / `20260918r34`; #2182 keeps the stale-browser Update Available badge authoritative. Stage 8 itch.io repository preparation remains complete through #2141.
...
- Three hands-on product checks remain unresolved: current deployed startup retest after #2182, sustained Solo stability after #2129, and the Defect 5 Banishment Flask exchange. The merged #2182 mainline also requires a verified push-triggered production smoke. Do not infer acceptance from automated tests.
...
- Stage 8 itch.io release preparation #2141 is merged. Its original artifact and the post-#2164 artifact are historical because later runtime/startup fixes changed the canonical runtime. The current qualified runtime publication candidate is `C64-Dungeon-Carnage-Itch`, artifact ID `10566350206`, 21,111,022 bytes, GitHub Actions SHA-256 `147782cb38cab392817b1bd4670f670ca0bcc2d51264839378d50bf229237be6`, workflow run `35390021405`, exact head `dfce128672fd90c8edf7900b3bac3a14095e58fe`. Later documentation-only PR qualification may emit another ZIP because this file is under the Dungeon path; such documentation-only package churn does not supersede the pinned runtime candidate unless a Dungeon runtime or package input changes. Repository-side release preparation is complete; public itch.io publication remains external and must wait for production smoke plus hands-on acceptance.
- Startup/first-visual remediation progressed through #2145, #2153, #2164 and #2180. #2180 exact head `c51522ab2b9b97046f23ed492d68a94b8fc3233f` merged as `bf4cfa4b68f1bc14bf89e81e71fa35fa585b2fb3`, preventing premature run/tutorial active-state flags from hiding the loader before authoritative readiness. #2181 then aligned the live production smoke. #2182 exact head `dfce128672fd90c8edf7900b3bac3a14095e58fe` merged as `4319ff84ea8bca41559347915d0ab5d2c1a0e873`, preventing the stale-browser Update Available badge from being overwritten by the legacy V10.41 brand observer. Automated qualification passed; the post-merge production smoke and deployed manual startup retest remain outstanding.
...
1. **Startup on current post-#2182 main** — loading must transition directly to the final V10.42 menu with no compact/intermediate menu flash and no loader → page → loader pulse; the stale-browser update path must retain the current Update Available label rather than reverting to V10.41.
...
9. **Startup/first-visual remediation — REPOSITORY-COMPLETE THROUGH #2182 / PRODUCTION SMOKE + MANUAL RETEST REMAIN.** #2145 established first-paint loader ownership, #2153 prevented reveal before final V10.42 menu composition, #2164 removed the transient legacy release-ready CSS hide, #2180 closed the premature run/tutorial active-state bypass, #2181 aligned the production smoke to r34, and #2182 kept the stale-build Update Available badge authoritative.
10. **Final qualification — EXACT-HEAD AUTOMATED PASS / LIVE + HANDS-ON REQUIRED.** Repository coding is complete unless the merged #2182 production smoke or a hands-on gate exposes a new reproducible defect. Verify the production smoke, then complete current startup, sustained Solo and Defect 5 Flask acceptance before external itch.io publication.
