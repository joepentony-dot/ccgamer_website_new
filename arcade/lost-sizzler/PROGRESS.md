...
- Latest verified Dungeon runtime merge checkpoint is `073ee3df35cd3982ceb04676619792d69a28e0e3`, the merge of #2185 from exact qualified head `ee8bef501b26271d1e1f38ad33c6c275b3290aba`. #2185 keeps the stale-browser `UPDATE AVAILABLE` label authoritative across scheduled V10.42 bootstrap restamps while preserving build/cache metadata ownership. Stage 8 itch.io repository preparation remains complete through #2141.
...
- Three hands-on product checks remain unresolved: current deployed startup retest after #2185, sustained Solo stability after #2129, and the Defect 5 Banishment Flask exchange. Post-#2185 production smoke, Pages deployment, live navigation and Site Safety are green; do not infer the three hands-on acceptances from automated tests.
...
- Stage 8 itch.io release preparation #2141 is merged. Earlier artifacts are historical because later runtime/startup fixes changed the canonical runtime. The current qualified runtime publication candidate is `C64-Dungeon-Carnage-Itch`, artifact ID `10575312850`, 21,111,070 bytes, GitHub Actions SHA-256 `6425e7f4cdd296843911c78e81a1545c661123bab726c4b2cdd9449d7334d73c`, workflow run `35414519473`, merged runtime `073ee3df35cd3982ceb04676619792d69a28e0e3`. Documentation-only package churn does not supersede this pinned runtime candidate unless a Dungeon runtime/package input changes. Repository-side release preparation and production smoke are complete; public itch.io publication remains external and must wait for hands-on acceptance.
- Startup/first-visual remediation progressed through #2145, #2153, #2164, #2180, #2182 and #2185. #2185 exact head `ee8bef501b26271d1e1f38ad33c6c275b3290aba` merged as `073ee3df35cd3982ceb04676619792d69a28e0e3`, preventing scheduled V10.42 bootstrap identity restamps from overwriting the stale-browser Update Available label. Exact-head qualification and deployed production smoke are green; deployed manual startup acceptance remains outstanding.
...
1. **Startup on current post-#2185 runtime** — loading must transition directly to the final V10.42 menu with no compact/intermediate menu flash and no loader → page → loader pulse; the stale-browser update path must retain the current Update Available label rather than being overwritten by any legacy or bootstrap build badge.
