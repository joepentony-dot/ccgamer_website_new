...
- Latest verified Dungeon runtime merge checkpoint is #2203: exact qualified head `8e1a18f6ec961cf44fe19800559e91154276ac8d`, merged as `1d875085c07f366561f4ae0dae5c3a8bbcda3019`. It preserves #2201's mobile trap/menu repairs and adds a mobile-only 1.3x Solo/Tutorial camera so the dungeon uses more of the available playfield; desktop and local 2P remain 1x. Build/cache are `V10.42 r37` / `20260921r37`.
...
11. **Mobile playfield camera — REPOSITORY-COMPLETE THROUGH #2203 / DEPLOYED MANUAL RETEST REMAINS.** Mobile Solo/Tutorial now render at 1.3x when the canvas is 900px wide or narrower, reducing unused playfield space. Desktop and local 2P remain 1x. Exact-head qualification passed the full triggered matrix including all six Chromium shards.
