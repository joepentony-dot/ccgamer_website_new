...
- Stage 8 itch.io release preparation #2141 is merged. Its original artifact is historical because later startup fixes changed the canonical runtime. The pinned runtime publication candidate is `C64-Dungeon-Carnage-Itch`, artifact ID `10561459333`, 21,110,985 bytes, GitHub Actions SHA-256 `f8a2142824b41b85d29006cf72d52c511b2bce9e879178ad9d45f4700a38c464`, workflow run `35380506012`. Later documentation-only PR qualification may emit another ZIP because this file is under the Dungeon path; such documentation-only package churn does not supersede the pinned runtime candidate unless a Dungeon runtime or package input changes. Repository-side release preparation is complete; public itch.io publication remains external and must wait for hands-on acceptance.
