...
- Latest verified Dungeon runtime merge checkpoint is `4319ff84ea8bca41559347915d0ab5d2c1a0e873`, the merge of #2182 from exact qualified head `dfce128672fd90c8edf7900b3bac3a14095e58fe`; current repository `main` is documentation-only checkpoint `66c2aa8441fc67961e1b3fa116da6537ea41002b`. #2180 previously closed a remaining premature run/tutorial active-state loader-hide path; #2181 aligned the production smoke to `V10.42 r34` / `20260918r34`; #2182 keeps the stale-browser Update Available badge authoritative. Stage 8 itch.io repository preparation remains complete through #2141.
...
- Three hands-on product checks remain unresolved: current deployed startup retest after #2182, sustained Solo stability after #2129, and the Defect 5 Banishment Flask exchange. The production smoke is now verified green on current deployed main; do not infer the three hands-on acceptances from automated tests.
