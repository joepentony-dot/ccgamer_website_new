...
- Mobile naturally-generated trap damage is **REPOSITORY-COMPLETE — #2192**. #2188 established the real-touch natural fire/spike/shock regression and initial synchronous repair; repeated exact-main qualification exposed a wrapper/phase-edge race, closed by #2192. Exact head `26ad5b4e3ca67c8480257479b46f587a21d8f66d` passed Site Safety, SEO, package, cache, native-wheel, dedicated Mobile Trap Layout, canonical/Node and all six Load Safety Chromium shards.
...
- Stage 8 itch.io release preparation #2141 is merged. Earlier artifacts are historical because later runtime/startup fixes changed the canonical runtime. The current qualified runtime publication candidate is `C64-Dungeon-Carnage-Itch`, artifact ID `10611582223`, 21,112,558 bytes, GitHub Actions SHA-256 `336c251ede6183f73a3469e5beaa4dca8a176349aa3fd0da86ea10eb6eb50235`, workflow run `35532598361`, exact source head `26ad5b4e3ca67c8480257479b46f587a21d8f66d`, merged by #2192 as `a281d4f620f267f67a8118bf469654d8273ec065`. Repository-side release preparation and production smoke are complete; public itch.io publication remains external and must wait for hands-on acceptance.
- Startup/first-visual remediation progressed through #2145, #2153, #2164, #2180, #2182 and #2185. #2182 prevented the legacy V10.41 brand observer from overwriting the stale-browser Update Available badge. #2185 exact head `ee8bef501b26271d1e1f38ad33c6c275b3290aba` merged as `073ee3df35cd3982ceb04676619792d69a28e0e3`, preventing the authoritative V10.42 ordered bootstrap from overwriting that stale-browser presentation during scheduled identity restamps. Exact-head qualification, deployed production smoke and push Load Safety (after one unchanged shard-3 stability retry) are green; deployed manual startup acceptance remains outstanding.
...
1. **Startup on current post-#2185 main** — loading must transition directly to the final V10.42 menu with no compact/intermediate menu flash and no loader → page → loader pulse; the stale-browser update path must retain the current Update Available label through V10.42 identity restamps.
...
10. **Mobile naturally-generated trap damage — REPOSITORY-COMPLETE THROUGH #2192.** #2188 established real-touch coverage; #2192 closes the remaining wrapper/phase-edge race. Active floor-trap contacts remove exactly one HP, preserve armour and retain R19 duplicate-contact/invulnerability ownership. The real-touch natural-trap regression is part of Load Safety.
