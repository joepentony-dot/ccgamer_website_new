...
- Repository promotion is complete: promotion commit `0a36821232eb2d7d3dd60a0773fd73df3eee6411` copied the 16 verified MP3 binaries into `assets/audio/music/`, and runtime switch commit `15d773e61596f6722b72805a6651275c21696cd1` moved bundled playlists to those package-local assets.
- Supabase deletion remains blocked until the relevant offline/online regression gates pass and a later explicit human review approves removal.
