window.CCG_CONFIG=Object.freeze({
  ...
  followerElites:[
    ...
    {name:"Parsnip Celery",initials:"PS",kind:"root",hp:7,armor:4,avatar:"assets/parsnip-celery.png",musicKey:"parsnip-celery",strength:"Root projectiles control open space from range.",weakness:"Walls stop the shots; rush from cover when the lane is broken."},
