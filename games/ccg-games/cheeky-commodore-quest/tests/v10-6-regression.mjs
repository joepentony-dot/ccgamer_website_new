...
const network=read("js/game-network.js"),core=read("js/game-core.js"),systems=read("js/systems.js"),runtime=read("js/v10-6-runtime.js"),finalUi=read("js/v10-4-final-ui.js"),patchV104=read("js/v10-4-patch.js"),weekly=read("js/weekly-challenge.js"),gamePlay=read("js/game-play.js"),gameRender=read("js/game-render.js"),menuHtml=read("index.html"),effectsV104=read("js/v10-4-collectible-effects.js"),effectsV105=read("js/v10-5-collectible-effects.js"),gameplayCss=read("css/v10-6-gameplay.css"),deathCachePatch=read("js/v10-4-death-cache.js");
...
assert.match(core,/Array\.from\(\{length:C\.player\.inventorySlots\}/);assert.match(core,/BUY AT SHOPS/);assert.match(core,/Purchase an Inventory Slot expansion at a dungeon shop/);
