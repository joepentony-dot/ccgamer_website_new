...
assert.equal(manifest.build,"2026.08.23.7","current published build must be explicit in the regression check");
assert.equal(manifest.cacheToken,"20260823r7","current release cache token must be explicit in the live manifest");
...
assert.match(index,/js\/v10-23-tutorial-guidance\.js\?v=20260823c/,"r7 must load the simplified tutorial launcher with a fresh dedicated revision");
assert.ok(index.indexOf("js/v10-23-tutorial-guidance.js?v=20260823c")<index.indexOf("js/asset-overrides.js?v=20260823r7"),"tutorial launch guidance must load before the enhancement queue");
...
console.log("Lost Sizzler r7 build, tutorial cache refresh, home recognition and scroll-safety regression checks passed.");
